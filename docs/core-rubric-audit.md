...
| Multiple profiles (3)             | High-energy-pop, chill-lofi, and deep-intense-rock output and comparison are in [README](../README.md#multiple-profile-evaluation).                                                                 | Three end-to-end BDD CLI scenarios and `test_real_cli_runs_all_named_profiles_successfully`. | Run `uv run python -m src.main --all-profiles --top-k 3`.     |
